...
public:
    /// constructor
    AP_OpticalFlow_UPFLOW(const char *model_name,OpticalFlow &_frontend, AP_HAL::UARTDriver *uart);
    ...
    static AP_OpticalFlow_UPFLOW *detect(const char *model_name,OpticalFlow &_frontend);
